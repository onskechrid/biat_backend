...
# Find the line containing "Solde fin"
solde_fin_line = None
lines = text.split('\n')
for line in lines:
    if 'Solde fin' in line:
        solde_fin_line = line
        break

# Extract the "Solde fin" value
solde_fin_value = ''
if solde_fin_line:
    solde_fin_value = solde_fin_line.split()[-1]

# Print the "Solde fin" value
print("Solde fin:", solde_fin_value)