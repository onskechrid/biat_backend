...
import lombok.*;
import tn.biat.biat.entities.pk.E_ACCOUNT_PERSO_BIAT_pk;
...
@AllArgsConstructor
@NoArgsConstructor
@IdClass(E_ACCOUNT_PERSO_BIAT_pk.class)
@Entity
@Table(name = "\"E_ACCOUNT_PERSO_BIAT\"", schema = "public")
@SequenceGenerator(schema = "public", name = "account_perso_biat_seq", allocationSize = 1, sequenceName = "account_perso_biat_seq")
public class E_ACCOUNT_PERSO_BIAT implements Serializable {

    @Column(name = "CDRCONTRH")
    private int CDRCONTRH;
    @Id
    @Column(name = "ID")
    @GeneratedValue(generator = "account_perso_biat_seq", strategy = GenerationType.SEQUENCE)
    private String ID;
    @Column(name = "CUST")
    private String CUST;
    @Column(name = "CATG")
    ...
    @Column(name = "ALLW_NETT")
    private String ALLW_NETT;
